...
<table width="100%" class="table_form ">
	...
	<tr>
        ...
        <tr>
        <th><?php echo L('catgory_tz')?>：</th>
        <td>
		<input type="text" name="info[catgory_lianjie]" id="catgory_lianjie" class="input-text" value="<?php echo $catgory_lianjie;?>" style="width:200px;">顶级栏目需要连接到下级某个栏目
		</td>
      </tr>
	 <tr>
